...
import fasthdr.tmo.Linear;

public class ToolBarLinear implements ToolBarInterface {
	
	private Linear tmo;
	
	public ToolBarLinear(){
		if(FastHDR.getFrame() != null){
			tmo = new Linear(FastHDR.getFrame(), FastHDR.getImagePanel());
		}
	}
